...
public class FieryController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ownWeapons.Add(new MonsterShotGun());
        ...
        {
            GameObject newBullet = Instantiate(Resources.Load("MonsterShotGunBullet") as GameObject);
            newBullet.transform.position = new Vector3(100.0f + i * 2.0f, 100.0f, 100.0f);
            newBullet.GetComponent<MonsterShotGunBullet>().setMagazinePos(new Vector3(100.0f + i * 2.0f, 100.0f, 100.0f));
    ...
    void shot()
    {
        ...
        bullets[bulletNum].GetComponent<MonsterShotGunBullet>().Direction = transform.forward;
